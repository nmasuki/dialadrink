  ...
  return (
    <div className="fixed bottom-4 left-0 right-0 z-50 pointer-events-none">
      <div className="max-w-md mx-auto px-4">
        <div className="flex items-center justify-center pointer-events-auto shadow-lg rounded-lg overflow-hidden">
          {/* View Cart Button */}
          <Link
            href="/cart"
            className="flex items-center gap-2 px-4 py-3 bg-white border-2 border-r-0 border-gray-300 hover:bg-gray-50 rounded-l-lg transition-colors"
          >
          ...
          <Link
            href="/checkout"
            className="px-6 py-3 bg-primary hover:bg-primary/90 text-white font-bold rounded-r-lg transition-colors text-center uppercase tracking-wide"
          >
            Instant Checkout
          </Link>
        </div>
