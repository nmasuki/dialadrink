...
Order.schema.set('toObject', {
	transform: function (doc, ret, options) {
		var whiteList = [
			'orderNumber', 'orderDate', 'modifiedDate',
			'notificationSent', 'state', 'promo',
			'cart', 'delivery', 'discount', 'subtotal', 'total'
		];
...
Order.defaultColumns = 'orderNumber, orderDate|20%, author|20%, publishedDate|20%';
Order.register();
