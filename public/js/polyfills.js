		...
		return new Promise(function (fulfill, reject) {
			var timeInterval = setInterval(function () {
				if (retry++ > maxRetries) {
					...
					reject("[Function {0}retryApply]: Max retries reached!\r\n".format(fnName) + stackTrace.join("\r\n"))
					return;
				} else if (retry > 1) {
...
if (!Array.prototype.sum)
	Array.prototype.sum = function (selector) {
		return this.aggregate(0.0, function(a, b) {return  a + (parseFloat(b) || 0)}, selector);
	};
...
if (!Array.prototype.prod)
	Array.prototype.prod = function (selector) {
		return this.aggregate(1.0, function(a, b) { return  a * (parseFloat(b) || 1)}, selector);
	};
...
if (!Array.prototype.distinctBy)
	Array.prototype.distinctBy = function (compare) {
		...
		return Object.keys(groups).map(function(k){return groups[k][0]});
	};
