...
;var cartUtil = function () {
    ...
    function c(e) {
        ...
        return e.image = e.product.image, e.currency = t.currency, e.price = t.price, e._id = e.product._id + "|" + e.quantity, e
    }
    ...
    var o = Object.assign(this, {
        view: function (t) {
            ...
            t.find(".cart-currency").html(a.currency || "KES"), t.find(".cart-price").html((e.pieces * a.price).formatNumber(2))
