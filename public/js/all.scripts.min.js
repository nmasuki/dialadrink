(function () {
    ...
    n.getListeners = function (e) {
        ...
        for (r in o) if (o.hasOwnProperty(r)) for (i = o[r].length; i--;) !0 === (n = o[r][i]).once && this.removeListener(e, n.listener), n.listener.apply(this, t || []) === this._getOnceReturnValue() && this.removeListener(e, n.listener);
        return this
    ...
    } : e.detachEvent && (r = function (t, n, i) {
        t.detachEvent("on" + n, t[n + i]);
        try {
            delete t[n + i]
        } catch (e) {
            t[n + i] = void 0
    ...
    function o(e, t, n) {
        ...
        "string" == typeof e && (e = document.querySelectorAll(e)), this.elements = function (e) {
            var t, n = [];
            if (t = e, "[object Array]" === h.call(t)) n = e; else if ("number" == typeof e.length) for (var i = 0, r = e.length; i < r; i++) n.push(e[i]); else n.push(e);
            return n
        }(e), this.options = r({}, this.options), "function" == typeof t ? n = t : r(this.options, t), n && this.on("always", n), this.getImages(), f && (this.jqDeferred = new f.Deferred);
        var i = this;
        setTimeout(function () {
            i.check()
        })
    ...
    var f = e.jQuery, c = e.console, a = void 0 !== c, h = Object.prototype.toString;
    (o.prototype = new t).options = {}, o.prototype.getImages = function () {
        ...
        for (var e = 0, t = this.elements.length; e < t; e++) {
            ...
            var i = n.nodeType;
            if (i && (1 === i || 9 === i || 11 === i)) for (var r = n.querySelectorAll("img"), o = 0, s = r.length; o < s; o++) {
                var f = r[o];
                this.addImage(f)
            }
        }
        ...
        function e(e, t) {
            return n.options.debug && a && c.log("confirm", e, t), n.progress(e), ++i === r && n.complete(), !0
        }

        var n = this, i = 0, r = this.images.length;
        if (this.hasAnyBroken = !1, r) for (var t = 0; t < r; t++) {
            var o = this.images[t];
        ...
        return new o(this, e, t).jqDeferred.promise(f(this))
    }), (i.prototype = new t).check = function () {
        var e = u[this.img.src] || new s(this.img.src);
    ...
    var u = {};
    return (s.prototype = new t).check = function () {
        if (!this.isChecked) {
            var e = new Image;
...
;!function (b) {
    b.flexslider = function (p, e) {
        ...
        var t, d = m.vars.namespace, f = window.navigator && window.navigator.msPointerEnabled && window.MSGesture,
            ...
            S = 0 < m.vars.itemWidth, x = "fade" === m.vars.animation, v = "" !== m.vars.asNavFor, y = {};
        b.data(p, "flexslider", m), y = {
            init: function () {
                m.animating = !1, m.currentSlide = parseInt(m.vars.startAt ? m.vars.startAt : 0, 10), isNaN(m.currentSlide) && (m.currentSlide = 0), m.animatingTo = m.currentSlide, m.atEnd = 0 === m.currentSlide || m.currentSlide === m.last, m.containerSelector = m.vars.selector.substr(0, m.vars.selector.search(" ")), m.slides = b(m.vars.selector, m), m.container = b(m.containerSelector, m), m.count = m.slides.length, m.syncExists = 0 < b(m.vars.sync).length, "slide" === m.vars.animation && (m.vars.animation = "swing"), m.prop = g ? "top" : "marginLeft", m.args = {}, m.manualPause = !1, m.stopped = !1, m.started = !1, m.startTimeout = null, m.transitions = !m.vars.video && !x && m.vars.useCSS && function () {
                    ...
                    return !1
                }(), (m.ensureAnimationEnd = "") !== m.vars.controlsContainer && (m.controlsContainer = 0 < b(m.vars.controlsContainer).length && b(m.vars.controlsContainer)), "" !== m.vars.manualControls && (m.manualControls = 0 < b(m.vars.manualControls).length && b(m.vars.manualControls)), m.vars.randomize && (m.slides.sort(function () {
                ...
                }), m.vars.mousewheel && m.bind("mousewheel", function (e, t) {
                    e.preventDefault();
                    var a = t < 0 ? m.getTarget("next") : m.getTarget("prev");
                    m.flexAnimate(a, m.vars.pauseOnAction)
                ...
                setup: function () {
                    ...
                    m.controlsContainer ? b(m.controlsContainer).append(m.controlNavScaffold) : m.append(m.controlNavScaffold), y.controlNav.set(), y.controlNav.active(), m.controlNavScaffold.delegate("a, img", r, function (e) {
                        ...
                        "" === o && (o = e.type), y.setToClearWatchedEvent()
                    })
                }, setupManual: function () {
                    m.controlNav = m.manualControls, y.controlNav.active(), m.controlNav.bind(r, function (e) {
                        if (e.preventDefault(), "" === o || o === e.type) {
                            var t = b(this), a = m.controlNav.index(t);
                            t.hasClass(d + "active") || (m.direction = a > m.currentSlide ? "next" : "prev", m.flexAnimate(a, m.vars.pauseOnAction))
                        }
                    ...
                    1 < m.pagingCount && "add" === e ? m.controlNavScaffold.append(b("<li><a>" + m.count + "</a></li>")) : 1 === m.pagingCount ? m.controlNavScaffold.find("li").remove() : m.controlNav.eq(t).closest("li").remove(), y.controlNav.set(), 1 < m.pagingCount && m.pagingCount !== m.controlNav.length ? m.update(t, e) : y.controlNav.active()
                }
            }, directionNav: {
                setup: function () {
                    var e = b('<ul class="' + d + 'direction-nav"><li><a class="' + d + 'prev" href="#">' + m.vars.prevText + '</a></li><li><a class="' + d + 'next" href="#">' + m.vars.nextText + "</a></li></ul>");
                    m.controlsContainer ? (b(m.controlsContainer).append(e), m.directionNav = b("." + d + "direction-nav li a", m.controlsContainer)) : (m.append(e), m.directionNav = b("." + d + "direction-nav li a", m)), y.directionNav.update(), m.directionNav.bind(r, function (e) {
                        var t;
                        e.preventDefault(), ("" === o || o === e.type) && (t = b(this).hasClass(d + "next") ? m.getTarget("next") : m.getTarget("prev"), m.flexAnimate(t, m.vars.pauseOnAction)), "" === o && (o = e.type), y.setToClearWatchedEvent()
                    })
                }, update: function () {
                    var e = d + "disabled";
                ...
                setup: function () {
                    var e = b('<div class="' + d + 'pauseplay"><a></a></div>');
                    m.controlsContainer ? (m.controlsContainer.append(e), m.pausePlay = b("." + d + "pauseplay a", m.controlsContainer)) : (m.append(e), m.pausePlay = b("." + d + "pauseplay a", m)), y.pausePlay.update(m.vars.slideshow ? d + "pause" : d + "play"), m.pausePlay.bind(r, function (e) {
                        e.preventDefault(), ("" === o || o === e.type) && (b(this).hasClass(d + "pause") ? (m.manualPause = !0, m.manualPlay = !1, m.pause()) : (m.manualPause = !1, m.manualPlay = !0, m.play())), "" === o && (o = e.type), y.setToClearWatchedEvent()
                    })
                }, update: function (e) {
                ...
                function a(e) {
                    t = e.touches[0].pageX, u = e.touches[0].pageY, l = g ? i - u : i - t, (!(d = g ? Math.abs(l) < Math.abs(t - s) : Math.abs(l) < Math.abs(u - s)) || 500 < Number(new Date) - c) && (e.preventDefault(), !x && m.transitions && (m.vars.animationLoop || (l /= 0 === m.currentSlide && l < 0 || m.currentSlide === m.last && 0 < l ? Math.abs(l) / o + 2 : 1), m.setProps(r + l, "setTouch")))
                }

                function n() {
                    if (p.removeEventListener("touchmove", a, !1), m.animatingTo === m.currentSlide && !d && null !== l) {
                        var e = h ? -l : l, t = 0 < e ? m.getTarget("next") : m.getTarget("prev");
                        m.canAdvance(t) && (Number(new Date) - c < 550 && 50 < Math.abs(e) || Math.abs(e) > o / 2) ? m.flexAnimate(t, m.vars.pauseOnAction) : x || m.flexAnimate(m.currentSlide, m.vars.pauseOnAction, !0)
                    }
                    p.removeEventListener("touchend", n, !1), r = l = s = i = null
                }

                var i, s, r, o, l, c, d = !1, t = 0, u = 0, v = 0;
                f ? (p.style.msTouchAction = "none", p._gesture = new MSGesture, (p._gesture.target = p).addEventListener("MSPointerDown", function (e) {
                    ...
                    if (t) {
                        ...
                        return l = v += g ? n : a, d = g ? Math.abs(v) < Math.abs(-a) : Math.abs(v) < Math.abs(-n), e.detail === e.MSGESTURE_FLAG_INERTIA ? void setImmediate(function () {
                            p._gesture.stop()
                        }) : void((!d || 500 < Number(new Date) - c) && (e.preventDefault(), !x && t.transitions && (t.vars.animationLoop || (l = v / (0 === t.currentSlide && v < 0 || t.currentSlide === t.last && 0 < v ? Math.abs(v) / o + 2 : 1)), t.setProps(r + l, "setTouch"))))
                    }
                ...
                }, !1)) : p.addEventListener("touchstart", function (e) {
                    m.animating ? e.preventDefault() : (window.navigator.msPointerEnabled || 1 === e.touches.length) && (m.pause(), o = g ? m.h : m.w, c = Number(new Date), t = e.touches[0].pageX, u = e.touches[0].pageY, r = S && h && m.animatingTo === m.last ? 0 : S && h ? m.limit - (m.itemW + m.vars.itemMargin) * m.move * m.animatingTo : S && m.currentSlide === m.last ? m.limit : S ? (m.itemW + m.vars.itemMargin) * m.move * m.currentSlide : h ? (m.last - m.currentSlide + m.cloneOffset) * o : (m.currentSlide + m.cloneOffset) * o, i = g ? u : t, s = g ? t : u, p.addEventListener("touchmove", a, !1), p.addEventListener("touchend", n, !1))
                }, !1)
            }, resize: function () {
                ...
                visProp: null, init: function () {
                    ...
                    if (y.pauseInvisible.visProp) {
                        var a = y.pauseInvisible.visProp.replace(/[H|h]idden/, "") + "visibilitychange";
                        document.addEventListener(a, function () {
                            y.pauseInvisible.isHidden() ? m.startTimeout ? clearTimeout(m.startTimeout) : m.pause() : m.started ? m.play() : 0 < m.vars.initDelay ? setTimeout(m.play, m.vars.initDelay) : m.play()
                        })
                    }
                }, isHidden: function () {
            ...
            x ? (m.slides.css({
                ...
                display: "block",
                zIndex: 1
            }).eq(m.currentSlide).css({zIndex: 2}).animate({opacity: 1}, m.vars.animationSpeed, m.vars.easing)), m.vars.smoothHeight && y.smoothHeight()) : ("init" === e && (m.viewport = b('<div class="' + d + 'viewport"></div>').css({
                overflow: "hidden",
                position: "relative"
            ...
            m.doMath(), S || (e < m.currentSlide ? m.currentSlide += 1 : e <= m.currentSlide && 0 !== e && (m.currentSlide -= 1), m.animatingTo = m.currentSlide), m.vars.controlNav && !m.manualControls && ("add" === t && !S || m.pagingCount > m.controlNav.length ? y.controlNav.update("add") : ("remove" === t && !S || m.pagingCount < m.controlNav.length) && (S && m.currentSlide > m.last && (m.currentSlide -= 1, m.animatingTo -= 1), y.controlNav.update("remove", m.last))), m.vars.directionNav && y.directionNav.update()
        ...
        if (void 0 === n && (n = {}), "object" == typeof n) return this.each(function () {
            ...
            1 === a.length && !0 === n.allowOneSlide || 0 === a.length ? (a.fadeIn(400), n.start && n.start(e)) : void 0 === e.data("flexslider") && new b.flexslider(this, n)
        });
...
;!function (d) {
    ...
    d.zoom = function (o, n, e, t) {
        var i, c, u, a, m, s, r, l = d(o), f = l.css("position"), h = d(n);
        return l.css("position", /(absolute|fixed)/.test(f) ? f : "relative"), l.css("overflow", "hidden"), e.style.width = e.style.height = "", d(e).addClass("zoomImg").css({
            position: "absolute",
            top: 0,
            left: 0,
            opacity: 0,
            ...
            init: function () {
                c = l.outerWidth(), i = l.outerHeight(), n === l[0] ? (a = c, u = i) : (a = h.outerWidth(), u = h.outerHeight()), m = (e.width - c) / a, s = (e.height - i) / u, r = h.offset()
            }, move: function (o) {
                var n = o.pageX - r.left, t = o.pageY - r.top;
                t = Math.max(Math.min(t, u), 0), n = Math.max(Math.min(n, a), 0), e.style.left = n * -m + "px", e.style.top = t * -s + "px"
            }
        }
    }, d.fn.zoom = function (h) {
        return this.each(function () {
            var o, n, t, i = d.extend({}, v, h || {}), c = i.target || this, u = this, a = d(u), e = d(c),
                m = document.createElement("img"), s = d(m), r = "mousemove.zoom", l = !1, f = !1;
            (i.url || ((o = a.find("img"))[0] && (i.url = o.data("src") || o.attr("src")), i.url)) && (n = e.css("position"), t = e.css("overflow"), a.one("zoom.destroy", function () {
                a.off(".zoom"), e.css("position", n), e.css("overflow", t), s.remove(), m.onload = null
            }), m.onload = function () {
                function n(o) {
                    e.init(), e.move(o), s.stop().fadeTo(d.support.opacity ? i.duration : 0, 1, !!d.isFunction(i.onZoomIn) && i.onZoomIn.call(m))
                }

                function t() {
                    s.stop().fadeTo(i.duration, 0, !!d.isFunction(i.onZoomOut) && i.onZoomOut.call(m))
                }

                var e = d.zoom(c, u, m, i.magnify);
                "grab" === i.on ? a.on("mousedown.zoom", function (o) {
                    1 === o.which && (d(document).one("mouseup.zoom", function () {
                        t(), d(document).off(r, e.move)
                    }), n(o), d(document).on(r, e.move), o.preventDefault())
                }) : "click" === i.on ? a.on("click.zoom", function (o) {
                    return l ? void 0 : (l = !0, n(o), d(document).on(r, e.move), d(document).one("click.zoom", function () {
                        t(), l = !1, d(document).off(r, e.move)
                    }), !1)
                }) : "toggle" === i.on ? a.on("click.zoom", function (o) {
                    l ? t() : n(o), l = !l
                }) : "mouseover" === i.on && (e.init(), a.on("mouseover.zoom", n).on("mouseleave.zoom", t).on(r, e.move)), i.touch && a.on("touchstart.zoom", function (o) {
                    o.preventDefault(), f ? (f = !1, t()) : (f = !0, n(o.originalEvent.touches[0] || o.originalEvent.changedTouches[0]))
                }).on("touchmove.zoom", function (o) {
                    o.preventDefault(), e.move(o.originalEvent.touches[0] || o.originalEvent.changedTouches[0])
                }), d.isFunction(i.callback) && i.callback.call(m)
            }, m.src = i.url)
        })
    }, d.fn.zoom.defaults = v
}(window.jQuery);
;!function (n, i, _, c) {
    var o = _("html"), r = _(n), d = _(i), S = _.fb = function () {
        S.open.apply(this, arguments)
    }, a = navigator.userAgent.match(/msie/i), l = null, s = i.createTouch !== c, p = function (e) {
        ...
        return t && T(e) && (i *= S.getViewport()[t] / 100), Math.ceil(i)
    }, E = function (e, t) {
        return L(e, t) + "px"
    };
    _.extend(S, {
        ...
        defaults: {
            ...
            modal: !1,
            loop: !0,
            ajax: {dataType: "html", headers: {"X-fb": !0}},
        ...
        open: function (s, d) {
            ...
            }), S.opts = _.extend(!0, {}, S.defaults, d), d.keys !== c && (S.opts.keys = !!d.keys && _.extend({}, S.defaults.keys, d.keys)), S.group = s, S._start(S.opts.index)
        },
        cancel: function () {
            var e = S.coming;
        ...
        close: function (e) {
            S.cancel(), !1 !== S.trigger("beforeClose") && (S.unbindEvents(), S.isActive && (S.isOpen && !0 !== e ? (S.isOpen = S.isOpened = !1, S.isClosing = !0, _(".fb-item, .fb-nav").remove(), S.wrap.stop(!0, !0).removeClass("fb-opened"), S.transitions[S.current.closeMethod]()) : (_(".fb-wrap").stop(!0).trigger("onReset").remove(), S._afterZoomOut())))
        },
        play: function (e) {
            var t = function () {
                ...
                t(), d.unbind(".player"), S.player.isActive = !1, S.trigger("onPlayEnd")
            };
            !0 === e || !S.player.isActive && !1 !== e ? S.current && (S.current.loop || S.current.index < S.group.length - 1) && (S.player.isActive = !0, d.bind({
        ...
        jumpto: function (e, t, i) {
            var n = S.current;
            n && (e = L(e), S.direction = t || n.direction[e >= n.index ? "next" : "prev"], S.router = i || "jumpto", n.loop && (e < 0 && (e = n.group.length + e % n.group.length), e %= n.group.length), n.group[e] !== c && (S.cancel(), S._start(e)))
        },
        reposition: function (e, t) {
            var i, n = S.current, o = n ? n.wrap : null;
            o && (i = S._getPosition(t), e && "scroll" === e.type ? (delete i.position, o.stop(!0, !0).animate(i, 200)) : (o.css(i), n.pos = _.extend({}, n.dim, i)))
        },
        update: function (t) {
            var i = t && t.type, n = !i || "orientationchange" === i;
            n && (clearTimeout(l), l = null), S.isOpen && !l && (l = setTimeout(function () {
                var e = S.current;
                e && !S.isClosing && (S.wrap.removeClass("fb-tmp"), (n || "load" === i || "resize" === i && e.autoResize) && S._setDimension(), "scroll" === i && e.canShrink || S.reposition(t), S.trigger("onUpdate"), l = null)
            }, n && !s ? 0 : 300))
        },
        toggle: function (e) {
            S.isOpen && (S.current.fitToView = "boolean" === _.type(e) ? e : !S.current.fitToView, s && (S.wrap.removeAttr("style").addClass("fb-tmp"), S.trigger("onUpdate")), S.update())
        },
        hideLoading: function () {
            d.unbind(".loading"), _("#fb-loading").remove()
        },
        showLoading: function () {
            var e, t;
            S.hideLoading(), e = _('<div id="fb-loading"><div></div></div>').click(S.cancel).appendTo("body"), d.bind("keydown.loading", function (e) {
        ...
        getViewport: function () {
            var e = S.current && S.current.locked || !1, t = {x: r.scrollLeft(), y: r.scrollTop()};
            return e ? (t.w = e[0].clientWidth, t.h = e[0].clientHeight) : (t.w = s && n.innerWidth ? n.innerWidth : r.width(), t.h = s && n.innerHeight ? n.innerHeight : r.height()), t
        },
        unbindEvents: function () {
            S.wrap && p(S.wrap) && S.wrap.unbind(".fb"), d.unbind(".fb"), r.unbind(".fb")
        },
        bindEvents: function () {
            var t, a = S.current;
            a && (r.bind("orientationchange.fb" + (s ? "" : " resize.fb") + (a.autoCenter && !a.locked ? " scroll.fb" : ""), S.update), (t = a.keys) && d.bind("keydown.fb", function (i) {
                ...
                !i.ctrlKey && !i.altKey && !i.shiftKey && !i.metaKey && (!e || !e.type && !_(e).is("[contenteditable]")) && _.each(t, function (e, t) {
                    return 1 < a.group.length && t[n] !== c ? (S[e](t[n]), i.preventDefault(), !1) : -1 < _.inArray(n, t) ? (S[e](), i.preventDefault(), !1) : void 0
                })
            }), _.fn.mousewheel && a.mouseWheel && S.wrap.bind("mousewheel.fb", function (e, t, i, n) {
                for (var o = _(e.target || null), r = !1; o.length && !r && !o.is(".fb-skin") && !o.is(".fb-wrap");) r = o[0] && !(o[0].style.overflow && "hidden" === o[0].style.overflow) && (o[0].clientWidth && o[0].scrollWidth > o[0].clientWidth || o[0].clientHeight && o[0].scrollHeight > o[0].clientHeight), o = _(o).parent();
                0 !== t && !r && 1 < S.group.length && !a.canShrink && (0 < n || 0 < i ? S.prev(0 < n ? "down" : "left") : (n < 0 || i < 0) && S.next(n < 0 ? "up" : "right"), e.preventDefault())
            }))
        },
        trigger: function (i, e) {
            var t, n = e || S.coming || S.current;
            if (n) {
                if (_.isFunction(n[i]) && (t = n[i].apply(n, Array.prototype.slice.call(arguments, 1))), !1 === t) return !1;
                n.helpers && _.each(n.helpers, function (e, t) {
                    t && S.helpers[e] && _.isFunction(S.helpers[e][i]) && S.helpers[e][i](_.extend(!0, {}, S.helpers[e].defaults, t), n)
                }), d.trigger(i)
            }
        },
        isImage: function (e) {
        ...
        _start: function (e) {
            var t, i, n = {};
            if (e = L(e), !(t = S.group[e] || null)) return !1;
            if (t = (n = _.extend(!0, {}, S.opts, t)).margin, i = n.padding, "number" === _.type(t) && (n.margin = [t, t, t, t]), "number" === _.type(i) && (n.padding = [i, i, i, i]), n.modal && _.extend(!0, n, {
                closeBtn: !1,
                closeClick: !1,
                nextClick: !1,
                arrows: !1,
                ...
                if (i = n.type, t = n.href, !i) return S.coming = null, !(!S.current || !S.router || "jumpto" === S.router) && (S.current.index = e, S[S.router](S.direction));
                if (S.isActive = !0, "image" !== i && "swf" !== i || (n.autoHeight = n.autoWidth = !1, n.scrolling = "visible"), "image" === i && (n.aspectRatio = !0), "iframe" === i && s && (n.scrolling = "scroll"), n.wrap = _(n.tpl.wrap).addClass("fb-" + (s ? "mobile" : "desktop") + " fb-type-" + i + " fb-tmp " + n.wrapCSS).appendTo(n.parent || "body"), _.extend(n, {
                    skin: _(".fb-skin", n.wrap),
                    outer: _(".fb-outer", n.wrap),
                    inner: _(".fb-inner", n.wrap)
                }), _.each(["Top", "Right", "Bottom", "Left"], function (e, t) {
                    n.skin.css("padding" + t, E(n.padding[e]))
        ...
        _loadAjax: function () {
            var i = S.coming;
            S.showLoading(), S.ajaxLoad = _.ajax(_.extend({}, i.ajax, {
                url: i.href, error: function (e, t) {
                    S.coming && "abort" !== t ? S._error("ajax", e) : S.hideLoading()
                }, success: function (e, t) {
                    "success" === t && (i.content = e, S._afterLoad())
                }
            }))
        },
        _loadIframe: function () {
            ...
            _(e.wrap).bind("onReset", function () {
                ...
                _(this).data("ready", 1), s || _(this).bind("load.fb", S.update), _(this).parents(".fb-wrap").width("100%").removeClass("fb-tmp").show(), S._afterLoad()
            })), e.content = t.appendTo(e.inner), e.iframe.preload || S._afterLoad()
        },
        _preloadImages: function () {
            var e, t, i = S.group, n = S.current, o = i.length, r = n.preload ? Math.min(n.preload, o - 1) : 0;
            for (t = 1; t <= r; t += 1) "image" === (e = i[(n.index + t) % o]).type && e.href && ((new Image).src = e.href)
        },
        _afterLoad: function () {
            var i, e, t, n, o, r = S.coming, a = S.current;
            if (S.hideLoading(), r && !1 !== S.isActive) if (!1 === S.trigger("afterLoad", r, a)) r.wrap.stop(!0).trigger("onReset").remove(), S.coming = null; else {
                switch (a && (S.trigger("beforeChange", a), a.wrap.stop(!0).removeClass("fb-opened").find(".fb-item, .fb-nav").remove()), S.unbindEvents(), i = r.content, e = r.type, t = r.scrolling, _.extend(S, {
                    wrap: r.wrap,
                    skin: r.skin,
                    outer: r.outer,
                    inner: r.inner,
                    ...
                    case"ajax":
                    case"html":
                        r.selector ? i = _("<div>").html(i).find(r.selector) : p(i) && (i.data("fb-placeholder") || i.data("fb-placeholder", _('<div class="fb-placeholder"></div>').insertAfter(i).hide()), i = i.show().detach(), r.wrap.bind("onReset", function () {
                            _(this).find(i).length && i.hide().replaceAll(i.data("fb-placeholder")).data("fb-placeholder", !1)
                        }));
                        break;
                    case"image":
                        i = r.tpl.image.replace("{href}", n);
                        break;
                    case"swf":
                        i = '<object id="fb-swf" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%"><param name="movie" value="' + n + '"></param>', o = "", _.each(r.swf, function (e, t) {
        ...
        _setDimension: function () {
            var e, t, i, n, o, r, a, l, s, d = S.getViewport(), c = 0, p = !1, h = !1, f = (p = S.wrap, S.skin),
                u = S.inner, g = S.current, m = (h = g.width, g.height), v = g.minWidth, w = g.minHeight,
                b = g.maxWidth, y = g.maxHeight, x = g.scrolling, k = g.scrollOutside ? g.scrollbarWidth : 0,
                C = g.margin, O = L(C[1] + C[3]), W = L(C[0] + C[2]);
            if (p.add(f).add(u).width("auto").height("auto").removeClass("fb-tmp"), t = O + (C = L(f.outerWidth(!0) - f.width())), i = W + (e = L(f.outerHeight(!0) - f.height())), n = T(h) ? (d.w - t) * L(h) / 100 : h, o = T(m) ? (d.h - i) * L(m) / 100 : m, "iframe" === g.type) {
                if (s = g.content, g.autoHeight && 1 === s.data("ready")) try {
                    s[0].contentWindow.document.location && (u.width(n).height(9999), r = s.contents().find("body"), k && r.css("overflow-x", "hidden"), o = r.outerHeight(!0))
                } catch (e) {
                }
            } else (g.autoWidth || g.autoHeight) && (u.addClass("fb-tmp"), g.autoWidth || u.width(n), g.autoHeight || u.height(o), g.autoWidth && (n = u.width()), g.autoHeight && (o = u.height()), u.removeClass("fb-tmp"));
            if (h = L(n), m = L(o), l = n / o, v = L(T(v) ? L(v, "w") - t : v), b = L(T(b) ? L(b, "w") - t : b), w = L(T(w) ? L(w, "h") - i : w), r = b, a = y = L(T(y) ? L(y, "h") - i : y), g.fitToView && (b = Math.min(d.w - t, b), y = Math.min(d.h - i, y)), t = d.w - O, W = d.h - W, g.aspectRatio ? (b < h && (m = L((h = b) / l)), y < m && (h = L((m = y) * l)), h < v && (m = L((h = v) / l)), m < w && (h = L((m = w) * l))) : (h = Math.max(v, Math.min(h, b)), g.autoHeight && "iframe" !== g.type && (u.width(h), m = u.height()), m = Math.max(w, Math.min(m, y))), g.fitToView) if (u.width(h).height(m), p.width(h + C), d = p.width(), O = p.height(), g.aspectRatio) for (; (t < d || W < O) && v < h && w < m && !(19 < c++);) m = Math.max(w, Math.min(y, m - 10)), (h = L(m * l)) < v && (m = L((h = v) / l)), b < h && (m = L((h = b) / l)), u.width(h).height(m), p.width(h + C), d = p.width(), O = p.height(); else h = Math.max(v, Math.min(h, h - (d - t))), m = Math.max(w, Math.min(m, m - (O - W)));
            k && "auto" === x && m < o && h + C + k < t && (h += k), u.width(h).height(m), p.width(h + C), d = p.width(), O = p.height(), p = (t < d || W < O) && v < h && w < m, h = g.aspectRatio ? h < r && m < a && h < n && m < o : (h < r || m < a) && (h < n || m < o), _.extend(g, {
                dim: {
                    width: E(d),
                    height: E(O)
                },
            ...
            }), !s && g.autoHeight && w < m && m < y && !h && u.height("auto")
        },
        _getPosition: function (e) {
            var t = S.current, i = S.getViewport(), n = t.margin, o = S.wrap.width() + n[1] + n[3],
                r = S.wrap.height() + n[0] + n[2];
            n = {position: "absolute", top: n[0], left: n[3]};
            return t.autoCenter && t.fixed && !e && r <= i.h && o <= i.w ? n.position = "fixed" : t.locked || (n.top += i.y, n.left += i.x), n.top = E(Math.max(n.top, n.top + (i.h - r) * t.topRatio)), n.left = E(Math.max(n.left, n.left + (i.w - o) * t.leftRatio)), n
        },
        _afterZoomIn: function () {
            var t = S.current;
            t && (S.isOpen = S.isOpened = !0, S.wrap.css("overflow", "visible").addClass("fb-opened"), S.update(), (t.closeClick || t.nextClick && 1 < S.group.length) && S.inner.css("cursor", "pointer").bind("click.fb", function (e) {
        ...
        _afterZoomOut: function (e) {
            e = e || S.current, _(".fb-wrap").trigger("onReset").remove(), _.extend(S, {
                group: {},
                opts: {},
                router: !1,
                current: null,
        ...
        getOrigPosition: function () {
            var e = S.current, t = e.element, i = e.orig, n = {}, o = 50, r = 50, a = e.hPadding, l = e.wPadding,
                s = S.getViewport();
            return !i && e.isDom && t.is(":visible") && ((i = t.find("img:first")).length || (i = t)), p(i) ? (n = i.offset(), i.is("img") && (o = i.outerWidth(), r = i.outerHeight())) : (n.top = s.y + (s.h - r) * e.topRatio, n.left = s.x + (s.w - o) * e.leftRatio), ("fixed" === S.wrap.css("position") || e.locked) && (n.top -= s.y, n.left -= s.x), {
                top: E(n.top - a * e.topRatio),
                left: E(n.left - l * e.leftRatio),
                width: E(o + l),
                height: E(r + a)
            }
        }, step: function (e, t) {
            var i, n, o = t.prop, r = (n = S.current).wrapSpace, a = n.skinSpace;
            "width" !== o && "height" !== o || (i = t.end === t.start ? 1 : (e - t.start) / (t.end - t.start), S.isClosing && (i = 1 - i), n = e - (n = "width" === o ? n.wPadding : n.hPadding), S.skin[o](L("width" === o ? n : n - r * i)), S.inner[o](L("width" === o ? n : n - r * i - a * i)))
        }, zoomIn: function () {
            var e = S.current, t = e.pos, i = e.openEffect, n = "elastic" === i, o = _.extend({opacity: 1}, t);
            ...
            var e, t = S.current, i = t.nextEffect, n = t.pos, o = {opacity: 1}, r = S.direction;
            n.opacity = .1, "elastic" === i && (e = "down" === r || "up" === r ? "top" : "left", "down" === r || "right" === r ? (n[e] = E(L(n[e]) - 200), o[e] = "+=200px") : (n[e] = E(L(n[e]) + 200), o[e] = "-=200px")), "none" === i ? S._afterZoomIn() : S.wrap.css(n).animate(o, {
                duration: t.nextSpeed,
                easing: t.nextEasing,
                complete: S._afterZoomIn
            })
        }, changeOut: function () {
            var e = S.previous, t = e.prevEffect, i = {opacity: .1}, n = S.direction;
        ...
        el: _("html"),
        create: function (e) {
            e = _.extend({}, this.defaults, e), this.overlay && this.close(), this.overlay = _('<div class="fb-overlay"></div>').appendTo(S.coming ? S.coming.parent : e.parent), this.fixed = !1, e.fixed && S.defaults.fixed && (this.overlay.addClass("fb-overlay-fixed"), this.fixed = !0)
        },
        open: function (e) {
            var t = this;
            e = _.extend({}, this.defaults, e), this.overlay ? this.overlay.unbind(".overlay").width("auto").height("auto") : this.create(e), this.fixed || (r.bind("resize.overlay", _.proxy(this.update, this)), this.update()), e.closeClick && this.overlay.bind("click.overlay", function (e) {
                if (_(e.target).hasClass("fb-overlay")) return S.isActive ? S.close() : t.close(), !1
            }), this.overlay.css(e.css).show()
        },
        close: function () {
            var e, t;
            r.unbind("resize.overlay"), this.el.hasClass("fb-lock") && (_(".fb-margin").removeClass("fb-margin"), e = r.scrollTop(), t = r.scrollLeft(), this.el.removeClass("fb-lock"), r.scrollTop(e).scrollLeft(t)), _(".fb-overlay").remove().hide(), _.extend(this, {
                overlay: null,
                fixed: !1
            })
        },
        update: function () {
            var e, t = "100%";
            this.overlay.width(t).height("100%"), a ? (e = Math.max(i.documentElement.offsetWidth, i.body.offsetWidth), d.width() > e && (t = d.width())) : d.width() > r.width() && (t = d.width()), this.overlay.width(t).height(d.height())
        },
        onReady: function (e, t) {
            var i = this.overlay;
            _(".fb-overlay").stop(!0, !0), i || this.create(e), e.locked && this.fixed && t.fixed && (i || (this.margin = d.height() > r.height() && _("html").css("margin-right").replace("px", "")), t.locked = this.overlay.append(t.wrap), t.fixed = !1), !0 === e.showEarly && this.beforeShow.apply(this, arguments)
        },
        beforeShow: function (e, t) {
            var i, n;
            t.locked && (!1 !== this.margin && (_("*").filter(function () {
                return "fixed" === _(this).css("position") && !_(this).hasClass("fb-overlay") && !_(this).hasClass("fb-wrap")
            }).addClass("fb-margin"), this.el.addClass("fb-margin")), i = r.scrollTop(), n = r.scrollLeft(), this.el.addClass("fb-lock"), r.scrollTop(i).scrollLeft(n)), this.open(e)
        },
        onUpdate: function () {
        ...
        defaults: {type: "float", position: "bottom"}, beforeShow: function (e) {
            var t = S.current, i = t.title, n = e.type;
            if (_.isFunction(i) && (i = i.call(t.element, t)), h(i) && "" !== _.trim(i)) {
                switch (t = _('<div class="fb-title fb-title-' + n + '-wrap">' + i + "</div>"), n) {
                    case"inside":
                        n = S.skin;
                        break;
                    case"outside":
                    ...
                    case"over":
                        ...
                        break;
                    default:
                        n = S.skin, t.appendTo("body"), a && t.width(t.width()), t.wrapInner('<span class="child"></span>'), S.current.margin[2] += Math.abs(L(t.css("margin-bottom")))
                }
                t["top" === e.position ? "prependTo" : "appendTo"](n)
            }
        }
    }, _.fn.fb = function (r) {
        var a, l = _(this), s = this.selector || "", e = function (e) {
            var t, i, n = _(this).blur(), o = a;
            !e.ctrlKey && !e.altKey && !e.shiftKey && !e.metaKey && !n.is(".fb-wrap") && (t = r.groupAttr || "data-fb-group", (i = n.attr(t)) || (t = "rel", i = n.get(0)[t]), i && "" !== i && "nofollow" !== i && (o = (n = (n = s.length ? _(s) : l).filter("[" + t + '="' + i + '"]')).index(this)), r.index = o, !1 !== S.open(n, r) && e.preventDefault())
        };
        return a = (r = r || {}).index || 0, s && !1 !== r.live ? d.undelegate(s, "click.fb-start").delegate(s + ":not('.fb-item, .fb-nav')", "click.fb-start", e) : l.unbind("click.fb-start").bind("click.fb-start", e), this.filter("[data-fb-start=1]").trigger("click"), this
    }, d.ready(function () {
        var e, t;
        if (_.scrollbarWidth === c && (_.scrollbarWidth = function () {
            ...
            return e.remove(), t
        }), _.support.fixedPosition === c) {
            e = _.support;
            var i = 20 === (t = _('<div style="position:fixed;top:20px;"></div>').appendTo("body"))[0].offsetTop || 15 === t[0].offsetTop;
        ...
        _.extend(S.defaults, {
            ...
            parent: _("body")
        }), e = _(n).width(), o.addClass("fb-lock-test"), t = _(n).width(), o.removeClass("fb-lock-test"), _("<style type='text/css'>.fb-margin{margin-right:" + (t - e) + "px;}</style>").appendTo("head")
    })
...
;!function (l, e) {
    ...
    d.scrolls.add = function (l) {
        this.remove(l).push(l)
    };
    var o = {
        autoScrollSize: !0,
        autoUpdate: !0,
        debug: !(d.scrolls.remove = function (l) {
    ...
    l.prototype = {
        destroy: function () {
            ...
            var p = this, u = this.container, r = this.containerWrapper || u, f = this.namespace,
                v = m.extend(this.options, l || {}), b = {x: this.scrollx, y: this.scrolly}, o = this.wrapper,
            ...
            if (o) r.css({
                height: "auto",
                "margin-bottom": -1 * d.scroll.height + "px",
                "margin-right": -1 * d.scroll.width + "px",
                "max-height": ""
            }); else {
                if (this.wrapper = o = m("<div>").addClass("scroll-wrapper").addClass(u.attr("class")).css("position", "absolute" == u.css("position") ? "absolute" : "relative").insertBefore(u).append(u), u.is("textarea") && (this.containerWrapper = r = m("<div>").insertBefore(u).append(u), o.addClass("scroll-textarea")), r.addClass("scroll-content").css({
                    height: "auto",
                    "margin-bottom": -1 * d.scroll.height + "px",
                    "margin-right": -1 * d.scroll.width + "px",
                    "max-height": ""
                    ...
                    o.on("MozMousePixelScroll" + f, s), o.on("mousewheel" + f, s), d.mobile && o.on("touchstart" + f, function (l) {
                        var e = l.originalEvent.touches && l.originalEvent.touches[0] || l, o = e.pageX, s = e.pageY,
                            r = u.scrollLeft(), t = u.scrollTop();
            ...
            m.each(b, function (r, t) {
                var i = null, n = 1, c = "x" === r ? "scrollLeft" : "scrollTop", a = v.scrollStep, d = function () {
                    var l = u[c]();
                    u[c](l + a), 1 == n && h <= l + a && (l = u[c]()), -1 == n && l + a <= h && (l = u[c]()), u[c]() == l && i && i()
                }, h = 0;
                t.scroll || (t.scroll = p._getScroll(v["scroll" + r]).addClass("scroll-" + r), v.showArrows && t.scroll.addClass("scroll-element_arrows_visible"), t.mousewheel = function (l) {
                    ...
                    return (0 < e && h < o || e < 0 && 0 < h) && ((h += e) < 0 && (h = 0), o < h && (h = o), p.scrollTo = p.scrollTo || {}, p.scrollTo[c] = h, setTimeout(function () {
                    ...
                    return m(this).hasClass("scroll-arrow") ? (n = m(this).hasClass("scroll-arrow_more") ? 1 : -1, a = v.scrollStep * n, h = 0 < n ? e.maxScrollValue : 0) : (n = e.scrollbarOffset + e.scrollbarSize < e.eventOffset ? 1 : e.eventOffset < e.scrollbarOffset ? -1 : 0, a = Math.round(.75 * t.visible) * n, h = e.eventOffset - e.scrollbarOffset - (v.stepScrolling ? 1 == n ? e.scrollbarSize : 0 : Math.round(e.scrollbarSize / 2)), h = u[c]() + h / t.kx), p.scrollTo = p.scrollTo || {}, p.scrollTo[c] = v.stepScrolling ? u[c]() + a : h, v.stepScrolling && (i = function () {
                        h = u[c](), clearInterval(s), clearTimeout(o), s = o = 0
                    }, o = setTimeout(function () {
                        s = setInterval(d, 40)
                    }, v.duration + 100)), setTimeout(function () {
                        p.scrollTo && (u.animate(p.scrollTo, v.duration), p.scrollTo = null)
                    }, 1), p._handleMouseDown(i, l)
                }), t.scroll.bar.on("mousedown" + f, function (l) {
                    if (1 != l.which) return !0;
                    var o = l["x" === r ? "pageX" : "pageY"], s = u[c]();
                    return t.scroll.addClass("scroll-draggable"), m(document).on("mousemove" + f, function (l) {
                        ...
                        t.scroll.removeClass("scroll-draggable"), h = u[c]()
                    }, l)
                }))
            }), m.each(b, function (l, e) {
                var o = "scroll-scroll" + l + "_visible", s = "x" == l ? b.y : b.x;
                ...
                m.extend(e, "x" == l ? {
                    ...
                    visible: o.width()
                } : {offset: parseInt(u.css("top"), 10) || 0, size: u.prop("scrollHeight"), visible: o.height()})
                ...
                var o = "x" === l ? "left" : "top", s = "x" === l ? "outerWidth" : "outerHeight",
                    r = "x" === l ? "width" : "height", t = parseInt(u.css(o), 10) || 0, i = e.size, n = e.visible + t,
            ...
            return e[l] && (l = e[l]), l || (l = e.simple), l = "string" == typeof l ? m(l).appendTo(this.wrapper) : m(l), m.extend(l, {
            ...
            var o = this.container, s = this.containerWrapper || o, r = "scroll-scroll" + l + "_visible",
                t = "x" === l ? this.scrolly : this.scrollx,
                i = parseInt(this.container.css("x" === l ? "left" : "top"), 10) || 0, n = this.wrapper, c = e.size,
                a = e.visible + i;
            e.isVisible = 1 < c - a, e.isVisible ? (e.scroll.addClass(r), t.scroll.addClass(r), s.addClass(r)) : (e.scroll.removeClass(r), t.scroll.removeClass(r), s.removeClass(r)), "y" === l && (o.is("textarea") || c < a ? s.css({
                height: a + d.scroll.height + "px",
                "max-height": "none"
            }) : s.css({"max-height": a + d.scroll.height + "px"})), e.size == o.prop("scrollWidth") && t.size == o.prop("scrollHeight") && e.visible == n.width() && t.visible == n.height() && e.offset == (parseInt(o.css("left"), 10) || 0) && t.offset == (parseInt(o.css("top"), 10) || 0) || (m.extend(this.scrollx, {
    ...
    m.fn.scrollbar = function (o, s) {
        return "string" != typeof o && (s = o, o = "init"), void 0 === s && (s = []), m.isArray(s) || (s = [s]), this.not("body, .scroll-wrapper").each(function () {
            var l = m(this), e = l.data(d.data.name);
            (e || "init" === o) && (e || (e = new r(l)), e[o] && e[o].apply(e, s))
        }), this
    }, m.fn.scrollbar.options = o;
    var c, s, a = (c = 0, function (l) {
        var e, o, s, r, t, i, n;
        for (e = 0; e < d.scrolls.length; e++) o = (r = d.scrolls[e]).container, s = r.options, t = r.wrapper, i = r.scrollx, n = r.scrolly, (l || s.autoUpdate && t && t.is(":visible") && (o.prop("scrollWidth") != i.size || o.prop("scrollHeight") != n.size || t.width() != i.visible || t.height() != n.visible)) && (r.init(), s.debug && window.console && console.log({
            scrollHeight: o.prop("scrollHeight") + ":" + r.scrolly.size,
            scrollWidth: o.prop("scrollWidth") + ":" + r.scrollx.size,
    ...
    function t(l) {
        ...
        if (!d.data.outer) {
            ...
            d.data.inner = m("<div>").css(m.extend({}, e)), d.data.outer = m("<div>").css(m.extend({
                left: "-1000px",
                overflow: "scroll",
                position: "absolute",
                top: "-1000px"
            }, e)).append(d.data.inner).appendTo("body")
        }
        return d.data.outer.scrollLeft(1e3).scrollTop(1e3), {
    ...
    window.angular && (s = window.angular).module("jQueryScrollbar", []).provider("jQueryScrollbar", function () {
        ...
        return {
            restrict: "AC", link: function (l, e, o) {
                var s = t(o.jqueryScrollbar)(l);
                e.scrollbar(s || r.options).on("$destroy", function () {
                    e.scrollbar("destroy")
                })
            }
        }
...
}(window.Zepto || window.jQuery, window, document), function (s, n, e, t) {
    var i = function (t) {
...
;Object.values || (Object.values = function (r) {
...
}), Object.equals || (Object.equals = function (t, r) {
    if (t === r) return !0;
    ...
    for (var e in t) if (t.hasOwnProperty(e)) {
        ...
        if (t[e] !== r[e]) {
            ...
            if (!Object.equals(t[e], r[e])) return !1
        }
    }
    for (e in r) if (r.hasOwnProperty(e) && !t.hasOwnProperty(e)) return !1;
    return !0
}), Object.isEmpty || (Object.isEmpty = function (t) {
    if (null !== t && "object" == typeof t && "[object Object]" === Object.prototype.toString.call(t)) {
        for (var r in t) if (t.hasOwnProperty(r)) return !1;
        return !0
    }
    console.warn("isEmpty function only accept an Object")
}), Object.diff || (Object.diff = function (t, r) {
    if (r && !t) return Object.diff({}, r);
    if (t && !r) return Object.diff(t, {});
    var e, n = {};
    for (var o in r) r.hasOwnProperty(o) && (e = {}, "object" == typeof r[o] ? (e = Object.diff(t[o], r[o]), Object.isEmpty(e) || (n[o] = e)) : t && t.hasOwnProperty(o) && r[o] === t[o] || (n[o] = [t[o], r[o]]));
    return n
}), Function.prototype.stackTrace || (Function.prototype.stackTrace = function () {
    var r = [], e = !1;
    try {
        n.dont.exist += 0
    } catch (t) {
        if (t.stack) {
            for (var n = 0, o = (i = t.stack.split("\n")).length; n < o; n++) i[n].match(/^\s*(at)\s/) && r.push(i[n]);
            r.shift(), e = !0
        } else if (window.opera && t.message) {
            var i;
            for (n = 0, o = (i = t.message.split("\n")).length; n < o; n++) if (i[n].match(/^\s*(at)\s/)) {
                var p = i[n];
                i[n + 1] && (p += " at " + i[n + 1], n++), r.push(p)
            }
            r.shift(), e = !0
        }
    }
    if (!e) for (var t = arguments.callee.caller; t;) {
        var a = t.toString(), u = a.substring(a.indexOf("function") + 8, a.indexOf("")) || "anonymous";
        r.push(u), t = t.caller
    }
    return r
}), Function.prototype.retryApply || (Function.prototype.retryApply = function (i, p, a, t, u) {
    var s = 0, c = this, y = arguments.callee.caller.stackTrace();
    return a = a || 5, t = t || 1e3, new Promise(function (e, n) {
        var o = setInterval(function () {
            if (s++ > a) {
                clearInterval(o);
                var t = c.name ? c.name + "." : "";
                n("[Function {0}retryApply]: Max retries reached!\r\n".format(t) + y.join("\r\n"))
            } else {
                if ("function" != typeof p || !!p()) try {
                    var r = c.apply(i, u);
                    r instanceof Promise ? r.then(e).catch(n) : e(r), clearInterval(o)
                } catch (t) {
                    console.warn(t)
                }
            }
...
}), Function.prototype.retryCall || (Function.prototype.retryCall = function (t, r, e, n) {
    for (var o = [], i = 4; i < arguments.length; i++) o.push(arguments[i]);
    return this.retryApply(t, r, e, n, o)
}), Function.prototype.promiseApply || (Function.prototype.promiseApply = function (o) {
    for (var i = 0, p = this, a = [], t = 1; t < arguments.length; t++) a.push(arguments[t]);
    return new Promise(function (r, e) {
        var n = setInterval(function () {
            try {
                var t = p.apply(o, a);
                return clearInterval(n), void r(t)
            } catch (t) {
                console.log(t)
            }
            5 < ++i && (clearInterval(n), e("Max retries reached!"))
        }, 1e3)
    }).catch(console.debug)
}), Function.prototype.promiseCall || (Function.prototype.promiseCall = function (t) {
    for (var r = [], e = 1; e < arguments.length; e++) r.push(arguments[e]);
    return this.promiseApply.apply(this, t, r)
}), Number.prototype.format || (Number.prototype.format = Number.prototype.formatNumber = function (t, r) {
    var e = "\\d(?=(\\d{" + (r || 3) + "})+" + (0 < t ? "\\." : "$") + ")";
    return this.toFixed(Math.max(0, ~~t)).replace(new RegExp(e, "g"), "$&,")
}), String.prototype.format || (String.prototype.format = function () {
    var t = this;
    for (i in arguments) if (arguments.hasOwnProperty(i)) {
        var r = new RegExp("(\\{" + i + "\\})", "g"), e = arguments[i];
        try {
            ko && ko.unwrap && (e = ko.unwrap(e))
        } catch (t) {
        }
        t = t.replace(r, e)
    }
    ...
    var t = /[^\s"]+|"([^"]*)"/gi, r = this.toString(), e = [];
    do {
        var n = t.exec(r);
        null != n && e.push(n[1] ? n[1] : n[0])
    } while (null != n);
    return e
    ...
    return this.trimRight(t).trimLeft(t)
}, String.prototype.any || (String.prototype.contains = String.prototype.any = function (t) {
    return "function" == typeof t ? this.map(t).any(!0) : t ? 0 <= this.indexOf(t) : 0 < this.length
}), String.prototype.camelCaseToSentence || (String.prototype.camelCaseToSentence = function () {
    return this.trim().replace(/^[a-z]|[A-Z]/g, function (t, r) {
        return 0 === r ? t.toUpperCase() : " " + t.toLowerCase()
    })
...
}), String.prototype.toProperCase || (String.prototype.toProperCase = function (t) {
    return (t ? this.toLowerCase() : this).replace(/(^|[\s\xA0])[^\s\xA0]/g, function (t) {
        return t.toUpperCase()
    })
}), String.prototype.cleanId || (String.prototype.cleanId = function () {
...
}), String.prototype.truncate = function (t, r) {
    return t = t || 100, r = r || "...", this.length > t ? (this || "").substring(0, t - r.length).trim() + r : this
}, Array.prototype.nth || (Array.prototype.nth = function (t, r) {
    return r = (r || 1) - 1, t = t || function (t) {
        return !0
    }, this.filter(t)[r]
...
}), Array.prototype.last || (Array.prototype.last = function (t) {
    t = t || function (t) {
        return !0
    };
    var r = this.filter(t);
    return r[r.length - 1]
}), Array.prototype.any || (Array.prototype.contains = Array.prototype.any = function (t) {
    return "function" == typeof t ? this.map(t).any(!0) : t ? 0 <= this.indexOf(t) : 0 < this.length
}), Array.prototype.aggregate || (Array.prototype.aggregate = function (t, r, e) {
    if (e && "function" != typeof e) throw"selector must be a function..";
    return (e ? this.map(e) : this).reduce(r, t)
}), Array.prototype.sum || (Array.prototype.sum = function (t) {
    return this.aggregate(0, function (t, r) {
        return t + (parseFloat(r) || 0)
    }, t)
}), Array.prototype.avg || (Array.prototype.avg = function (t) {
    return this.sum(t) / this.length
}), Array.prototype.prod || (Array.prototype.prod = function (t) {
    return this.aggregate(1, function (t, r) {
        return t * (parseFloat(r) || 1)
    }, t)
}), Array.prototype.splitChunks || (Array.prototype.splitChunks = function (t) {
    var r, e = 10;
    "number" == typeof t ? (r = t, e = parseInt(this.length / r) + 1) : (t = t || {chunkCount: 10}).chunkSize ? (r = t.chunkSize, e = parseInt(this.length / r) + 1) : t.chunkCount && (e = t.chunkCount || 10);
    var n = this.groupBy(function (t, r) {
        return r % e
    });
    return Object.values(n)
}), Array.prototype.groupBy || (Array.prototype.groupBy = function (n) {
    var o = 0;
    return this.reduce(function (t, r) {
        var e = "function" == typeof n ? n(r, o) : r[n] || r || 0;
        return (t[e] = t[e] || []).push(r), o++, t
    }, {})
}), Array.prototype.group || (Array.prototype.group = function (t) {
    var r = this.groupBy();
    return Object.keys(r).map(function (t) {
        return r[t]
    })
}), Array.prototype.distinctBy || (Array.prototype.distinctBy = function (t) {
    var r = this.groupBy(t);
    return Object.keys(r).map(function (t) {
        return r[t][0]
    })
}), Array.prototype.distinct || (Array.prototype.distinct = function (t) {
    return this.distinctBy(t)
}), Array.prototype.orderBy || (Array.prototype.orderBy = function (o) {
    return this.slice(0).sort(function (t, r) {
        var e = "function" == typeof o ? o(t) : t[o] || t, n = "function" == typeof o ? o(r) : r[o] || r;
...
}), Array.prototype.orderByDescending || (Array.prototype.orderByDescending = function (o) {
    return this.slice(0).sort(function (t, r) {
        var e = "function" == typeof o ? o(t) : t, n = "function" == typeof o ? o(r) : r;
        return e < n ? 1 : n < e ? -1 : 0
    })
}), Array.prototype.max || (Array.prototype.max = function (t) {
    return this.orderBy(t).last()
}), Array.prototype.flatten || (Array.prototype.flatten = function (e) {
    return this.reduce(function (t, r) {
        return t.concat("function" == typeof e ? e(r) : r)
    }, [])
}), Math.sequence || (Math.sequence = function (t, r, e) {
    r = r || 100, t = t || 0;
    var n = [];
    if ("function" == typeof e) for (var o = t; o <= r; o++) n.push(e(o)); else for (o = t; o <= r; o++) n.push(o);
    return n
}), Date.isLeapYear = function (t) {
    return t % 4 == 0 && t % 100 != 0 || t % 400 == 0
}, Date.getDaysInMonth = function (t, r) {
    return [31, Date.isLeapYear(t) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][r]
}, Date.prototype.isLeapYear = function () {
    return Date.isLeapYear(this.getFullYear())
}, Date.prototype.getDaysInMonth = function () {
    return Date.getDaysInMonth(this.getFullYear(), this.getMonth())
}, Date.prototype.addYears = function (t) {
    var r = Math.floor(t), e = 12 * (t - r);
    return this.setYear(this.getYear() + r), e && this.addMonths(e), this
}, Date.prototype.addMonths = function (t) {
    var r = t % 12, e = Math.floor(t / 12);
    return this.setDate(1), this.setMonth(this.getMonth() + r), this.setDate(Math.min(this.getDate(), this.getDaysInMonth())), e && this.addYears(e), this
}, Date.prototype.addDays = function (t) {
    return this.addHours(24 * t)
}, Date.prototype.addHours = function (t) {
    return this.addMinutes(60 * t)
}, Date.prototype.addMinutes = function (t) {
    return this.addSeconds(60 * t)
}, Date.prototype.addSeconds = function (t) {
    return this.setTime(this.getTime() + 1e3 * t), this
};
;$.fn.startCountDown = function (l) {
    var s = $(this);
    if (!l) {
        var t = new Date((new Date).toISOString().substr(0, 10));
        l = new Date(t.getTime() + 864e5).getTime()
    }
    var a = setInterval(function () {
        var t = (new Date).getTime(), a = l - t, e = Math.floor(a / 864e5), n = Math.floor(a % 864e5 / 36e5),
            r = Math.floor(a % 36e5 / 6e4), o = Math.floor(a % 6e4 / 1e3), i = "";
        0 < e && (i += e + "d "), i += n.toString().padStart(2, "0") + ":" + r.toString().padStart(2, "0") + ":" + o.toString().padStart(2, "0"), a < 0 ? (clearInterval(x), s.parent().hide(), s.addClass("countDownTimer").html("")) : (s.parent().show(), s.addClass("countDownTimer").html(i))
    }, 1e3);
    s.data("interval", a)
...
;!function (s) {
    ...
    }), s.classie = {hasClass: e, addClass: t, removeClass: c, toggleClass: n, has: e, add: t, remove: c, toggle: n}
}(window);
;var touch = !1, clickEv = "click";

function slider_main() {
    $(".carousel").carousel({interval: !1, pause: !1})
}

function slider_product() {
    $(".home1_block_product").length && $(".home1_block_product").owlCarousel({
        navigation: !0,
        pagination: !1,
        autoPlay: !1,
        items: 4,
    ...
    }), $(".slider-3itemsc").length && $(".slider-3itemsc").owlCarousel({
        navigation: !0,
        pagination: !1,
        autoPlay: !1,
        items: 3,
        ...
        itemsMobile: [360, 3],
        navigationText: ['<i class="fa fa-angle-left" title="Previous" data-toggle="tooltip" data-placement="top"></i>', '<i class="fa fa-angle-right" title="Next" data-toggle="tooltip" data-placement="top"></i>']
    }), $(".related-products .rp-slider").length && $(".related-products .rp-slider").owlCarousel({
        navigation: !0,
        pagination: !1,
        items: 4,
        slideSpeed: 200,
        ...
        itemsMobile: [480, 1],
        navigationText: ['<i class="fa fa-angle-left" title="Previous" data-toggle="tooltip" data-placement="top"></i>', '<i class="fa fa-angle-right" title="Next" data-toggle="tooltip" data-placement="top"></i>']
    }), $(".home2_product_right").length && $(".home2_product_right").owlCarousel({
        navigation: !0,
        pagination: !1,
        autoPlay: !1,
        items: 3,
        ...
        itemsMobile: [420, 1],
        navigationText: ['<i class="fa fa-angle-left" title="Previous" data-toggle="tooltip" data-placement="top"></i>', '<i class="fa fa-angle-right" title="Next" data-toggle="tooltip" data-placement="top"></i>']
    }), $("#home3_partner_content").length && $("#home3_partner_content").owlCarousel({
        navigation: !0,
        pagination: !1,
        autoPlay: !0,
        items: 6,
        ...
        itemsMobile: [360, 2],
        navigationText: ['<i class="fa fa-angle-left" title="Previous" data-toggle="tooltip" data-placement="top"></i>', '<i class="fa fa-angle-right" title="Next" data-toggle="tooltip" data-placement="top"></i>']
    }), $(".home3_featured_product").length && $(".home3_featured_product").owlCarousel({
        navigation: !0,
        pagination: !1,
        autoPlay: !1,
        items: 4,
...
function handleDropdown() {
    $(".dropdown-toggle").length && $(".dropdown-toggle").parent().hover(function () {
        ...
        if (0 == touch && 767 < getWidthBrowser()) {
            var t = $(this).find("a.dropdown-toggle").attr("href");
            t && (window.location = t)
        }
...
function handleScrollTop() {
    function a(t) {
        var e = $("#scroll-to-top"), i = $(".cart-float-right");
...
function handleSearchingAndPaging() {
    $("#search").on("click", function (t) {
        t.preventDefault();
        var e = $("#search_box").val();
        "" !== e && (console.log(e), window.location.href = "/search/" + e)
    }), $(".disabled a, a.disabled").on("click", function (t) {
        t.preventDefault()
    })
}
...
function handleMap() {
    jQuery().gMap && $("#contact_map").length && $("#contact_map").gMap({
        ...
        scrollwheel: !1,
        maptype: "ROADMAP",
        markers: [{address: "474 Ontario St Toronto, ON M4X 1M7 Canada", html: "_address"}]
    })
}

function toggleLeftMenu() {
    if (window.innerWidth <= 767) {
        var t = document.getElementById("is-mobile-nav-menu"), e = document.getElementById("showLeftPush"),
            i = document.body;
        e.onclick = function () {
            classie.toggle(this, "active"), classie.toggle(i, "pushed"), classie.toggle(t, "leftnavi-open"), classie.has(this, "active") ? $("#showLeftPush").html("<i class='fa fa-times fa-2x'></i>") : $("#showLeftPush").html("<i class='fa fa-bars fa-2x'></i>")
        }
    }
}
...
function updateScrollThumbsQS() {
    $("#gallery_main_qs").length && ($("#quick-shop-image .fancybox").on(clickEv, function () {
        var i = [], a = 0;
        return $("#gallery_main_qs .image-thumb").each(function (t, e) {
            i.push({href: e.href, title: e.title}), $(this).hasClass("active") && (a = t)
        }), $.fancybox(i, {closeBtn: !0, index: a, helpers: {buttons: {}}}), !1
    }), $("#quick-shop-image").on(clickEv, ".image-thumb", function () {
        var t = $(this), e = $(".product-image .main-image .main-image-bg"), i = t.parents(".product-image-wrapper"),
            a = t.attr("data-image-zoom"), o = t.attr("data-image");
        return e.show(), i.find(".image-thumb").removeClass("active"), t.addClass("active"), i.find(".main-image").find("img").attr("data-zoom-image", a), i.find(".main-image").find("img").attr("src", o).load(function () {
            e.hide()
        }), !1
    }))
}
...
function addClassFirst() {
    var e = 1, i = 0;
    -1 != $(".main-content section").first().attr("class").indexOf("home3_slideshow") && (i = 1), $(".main-content section").each(function (t) {
        if (2 == e && 1 == i) -1 != $(this).attr("class").indexOf("home3_topbanner") && ($(this).addClass("padding-80"), $(".main-content section").first().addClass("padding-80")); else if (2 == e && 0 == i) $(this).attr("class").indexOf("main-slideshow"); else if (2 < e) return !1;
        e++
    })
}

function handleProductRating() {
    $(document).on("mouseover", ".unrated .glyphicon", function (t) {
        for (var e = $(this).index(), i = 0; i <= e; i++) $(".unrated .glyphicon").eq(i).css("color", "orange")
    }), $(document).on("mouseout", ".unrated", function () {
        $(this).find(".glyphicon").css("color", "black")
    }), $(document).on("click", ".unrated .glyphicon", function (t) {
        var e = $(this);
        e.parent().removeClass("unrated").addClass("rated");
        var i = e.parents("[data-product]").data("product");
        $.ajax(["/product/rate", i, parseInt(e.index()) + 1].join("/"))
    }), $(document).on("click", ".thumbnail.review-link", function (t) {
        var e = $(this).find("img").attr("src");
        $(this).parents(".row.product-thumbnails").siblings("img.image-responsive").attr("src", e)
    })
}
...
$(window).resize(function () {
    ...
    t('[data-toggle="tooltip"]').tooltip(), slider_main(), slider_product(), handleProductRating(), handleDropdown(), handleScrollTop(), handleSearchingAndPaging(), colorwarches(), handleQuantity(), handleGridList(), toggleTagsFilter(), handleMap(), toggleLeftMenu(), updateScrollThumbsQS(), addClassFirst()
...
;var cartUtil = function () {
    ...
    function c(e) {
        var t = e.product.priceOptions.find(function (t) {
            return t.option.quantity === e.quantity
        });
        return e._id = e._id || e.product._id + "|" + e.quantity, e.image = e.image || e.product.image, e.currency = e.currency || t.currency, e.price = e.price || t.offerPrice && t.price > t.offerPrice ? t.offerPrice : t.price, e
    }

    var o = Object.assign(this, {
        view: function (t) {
            var e = $("#cart-content-main, #cart-content-mini");
            return t ? e.find(t) : e
        }, init: function () {
            return $.get("/cart/get").then(function (t) {
                for (var e in i = t.cart, n = t.promo, i) i[e] = c(i[e]);
                o.updateView()
            })
        }, getCart: function () {
            return i
        }, getCartItem: function (t) {
            return i[t]
        }, addItem: function (t, e, a) {
            o.view(".number");
            var n = t + "|" + (a = a || ""), r = i[n] || (i[n] = {});
            return $.ajax({
                url: "/cart/add/" + t + "/" + a + "/" + (e || 1), type: "get", success: function (t) {
                    console.log(t, e), i[n] = c(Object.assign(r, t.item)), o.updateView()
                }
            })
        }, updateItem: function (e, t) {
            var a = i[e] || (i[e] = {});
            return $.ajax({
                url: "/cart/update/" + e + "/" + t, type: "get", success: function (t) {
                    i[e] = c(Object.assign(a, t.item)), o.updateView()
                }
            })
        }, removeItem: function (e) {
            var a = this;
            if (!i[e]) throw"Cart item not found! " + e;
            return $.ajax({
                url: "/cart/remove/" + e, type: "get", success: function (t) {
                    t.state ? (a.view("li[data-cartid='" + e + "']").hide(), delete i[e], a.updateTotals()) : console.log("Failed to remove cart item " + e, t.msg)
                }
            })
        }, piecesCount: function () {
            var t = 0;
            for (var e in i) t += parseInt(i[e].pieces);
            return t
        }, productCount: function () {
            return Object.values(i).distinct(function (t) {
                return t.product._id
            }).length
        }, totalCost: function () {
            var t = 0;
            for (var e in i) t += i[e].pieces * i[e].price;
            return t
        }, totalAmount: function () {
            var t = o.totalCost();
            return t - o.discount(t)
        }, discount: function (t, e) {
            return t = t || o.totalCost(), (e = e || n) && e.discountType ? Math.round("percent" === e.discountType ? t * e.discount / 100 : e.discount) : 0
        }, updateView: function (e, t) {
            e = e || i, t = t || n, Object.values(e).forEach(o.updateCartItemView), Object.keys(i).forEach(function (t) {
                e[t] || o.view("li[data-cartid='" + t + "']").hide()
            });
            var a = $(".promo-code-wrapper").slideDown();
            t && t.discountType && o.discount(null, t) ? (a.find(".promo-code").text(t.code), a.find(".promo-code-amount").text(o.discount(null, t).formatNumber(2))) : a.hide(), i = e, n = t, o.updateTotals()
        }, updateCartItemView: function (e) {
            if ("string" == typeof e && (e = o.getCartItem(e)), !e) throw"Missing [item] when updating cart item view";
            if (!e._id) throw"Missing [item._id] when updating cart item view";
            var t = function (n) {
                var t = o.view().find("[data-cartid='" + n + "']");
                if (t.length <= 0) {
                    var r = $("#cart-template").html();
                    o.view().each(function (t, e) {
                        var a = $(r);
                        a.find("li").data("cartId", n), $(e).append(a)
                    }), t = o.view().find("[data-cartid='" + n + "']")
                }
                return t
            }(e._id);
            t.find(".cart-image").attr("src", e.product.image.secure_url), t.find(".cart-product-link").attr("href", e.product.href).html(e.product.name + " " + e.quantity), t.find(".cart-description").html((e.description || "").truncate(50)), t.find(".cart-pieces").html(e.pieces);
            var a = e.product.priceOptions.find(function (t) {
                return t.option.quantity === e.quantity
            });
            t.find(".cart-currency").html(e.currency || a.currency || "KES"), t.find(".cart-price").html((e.pieces * e.price).formatNumber(2))
        }, updateTotals: function () {
            $(".cart-total-products").html(o.productCount()), $(".cart-total-pieces").html(o.piecesCount());
            var t = o.totalAmount().formatNumber(2);
            o.totalAmount() !== o.totalCost() && (t = "<span style='font-size: 0.8em; text-decoration: line-through; color: orangered'>{0}</span>".format(o.totalCost().formatNumber(2)) + t), $(".cart-total").html(t)
        }
    });
    return o.init(), o
};
window.app = window.app || {cartUtil: new cartUtil}, $(function () {
    $(document).on("click", ".add-to-cart", function (t) {
        t.preventDefault();
        var e = $(this).data("product"), a = $(this).data("qty");
        if (e) {
            console.log("The id is this after changes", e);
            var n = $(this).parents("#product-section").find(".pieces"), r = parseInt(n.val()) || 1;
            app.cartUtil.addItem(e, r, a)
        } else console.warn("Could not add to cart, [data-product] attribute missing on", $(this))
    }), $(document).on("change", ".cart-pieces", function (t) {
        t.preventDefault();
        var e = $(this).val(), a = $(this).parents("[data-cartid]").data("cartid");
        app.cartUtil.updateItem(a, e)
    }), $(document).on("click", ".cart-remove", function (t) {
        t.preventDefault();
        var e = $(this).parents("[data-cartid]").data("cartid");
        app.cartUtil.removeItem(e)
    }), $(document).on("click", ".pieces-minus", function () {
        var t = $(this).siblings(".pieces"), e = parseInt(t.val()) || 1;
        t.val(--e);
        var a = $(this).parents("[data-cartid]").data("cartid");
        a ? app.cartUtil.updateItem(a, e) : console.warn("Could not get cart id!!")
    }), $(document).on("click", ".pieces-plus", function () {
        var t = $(this).siblings(".pieces"), e = parseInt(t.val()) || 1;
        t.val(++e);
        var a = $(this).parents("[data-cartid]").data("cartid");
        a ? app.cartUtil.updateItem(a, e) : console.warn("Could not get cart id!!")
    }), $(document).on("change", "#change-quantity", function (t) {
        t.preventDefault();
        var e = $(this).find(":selected").data("option");
        console.log(e), $("#product-data").attr("data-product", e);
        var a = $(this).val();
        $("#product-price").html(a);
        var n = $(this).find(":selected").text().trim();
        $(".add-to-cart").data("qty", n)
    }), $(document).on("click", "#checkout-form", function (t) {
        t.preventDefault();
        var e = $("#name").val(), a = $("#phone").val(), n = $("#location").val(), r = $("#street").val(),
            i = $("#building").val(), c = $("#houseno").val(), o = $("#_csrf").val(), u = $("#email").val();
        if ("" != e && "" != a && "" != n && "" != u) data = {
            street: r,
            building: i,
            houseno: c,
            ...
            type: "get",
            url: "/cart/checkout/" + e + "/" + n + "/" + a + "/" + u + "/" + r + "/" + i + "/" + c,
            data: data,
            success: function (t) {
                console.log(t), t.state && (window.location.href = "/order-placed")
            },
            error: function (t, e, a) {
                console.log(t, e, a)
            }
        }); else {
            $(".checkout-error").html("Please fill all the fields and try again")
        }
    })
});
;var app = {
    ...
    initPickColor: function () {
        $(".pick-class-label").click(function () {
            var e = $(this).attr("new-class"), t = $("#display-buttons"), i = t.attr("data-class");
            if (t.length) {
                var o = t.find(".btn");
                o.removeClass(i), o.addClass(e), t.attr("data-class", e)
            }
        })
    },
    initChartist: function () {
        ...
        Chartist.Pie("#chartPreferences", {series: [[25, 30, 20, 25]]}, {
            donut: !0,
            donutWidth: 40,
            startAngle: 0,
            total: 100,
    ...
    initGoogleMaps: function () {
        ...
        new google.maps.Marker({position: e, title: "Hello World!"}).setMap(i)
    },
    hideModal: function () {
    ...
    showLoading: function (e, t) {
        app.hideModal();
        var i, o = $($("#loading-template").html());

        function a(e) {
            this.$element = $(e), this.$content = this.$element.find(".modal-content");
            var t = this.$content.outerHeight() - this.$content.innerHeight(), i = $(window).width() < 768 ? 20 : 60,
                o = $(window).height() - (i + t) - ((this.$element.find(".modal-header").outerHeight() || 0) + (this.$element.find(".modal-footer").outerHeight() || 0));
        ...
        $(document.body).append(o), o.on("hidden.bs.modal", function () {
            o.siblings(".modal-backdrop.in").hide(), o.remove(), i && clearTimeout(i)
        }), o.find(".lading-msg").html(e), o.on("show.bs.modal", function () {
            $(this).show(), a(this)
        }), $(window).resize(function () {
            0 !== $(".modal.in").length && a($(".modal.in"))
        }), o.modal({keyboard: !1, backdrop: "static"}), t = t || 1e4, i = setTimeout(function () {
            o.modal("hide")
        }, t, "hide")
    },
    showModal: function (e) {
        app.hideModal();
        (e = e || {}).title;
        var t = e.msg || e.message, i = $($("#modal-template").html());
        $(document.body).append(i), "function" == typeof e.ok && i.find(".btn-primary").on("click", function () {
            e.ok.apply(this, arguments)
        }), "function" == typeof e.close && i.find(".btn-secondary, .close").on("click", function () {
            e.close.apply(this, arguments)
        }), i.on("hidden.bs.modal", function () {
            $(".modal.loading").modal("hide"), i.siblings(".modal-backdrop.in").hide(), i.remove()
        }), i.find(".modal-body").html(t), i.modal({keyboard: !1, backdrop: "static"})
    },
    showNotification: function (e, t) {
        ...
        }, {type: app.type[i], timer: 4e3, placement: {from: e, align: t}})
    }
};