...
function getSendOptions (options) {
	...
	var toRecipientsAndMergeVars = getRecipientsAndMergeVars(options.to);
	var ccRecipientsAndMergeVars = getRecipientsAndMergeVars(options.cc || []);
	var bccRecipientsAndMergeVars = getRecipientsAndMergeVars(options.bcc || []);

	options.to = toRecipientsAndMergeVars.recipients;
	options.cc = ccRecipientsAndMergeVars.recipients;
	options.bcc = bccRecipientsAndMergeVars.recipients;
	options.merge_vars = toRecipientsAndMergeVars.mergeVars;
