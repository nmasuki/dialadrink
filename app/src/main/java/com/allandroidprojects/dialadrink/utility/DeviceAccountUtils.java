...
public class DeviceAccountUtils {
    ...
    /**
     * Interface for interacting with the result of {@link DeviceAccountUtils#getUserProfile}.
     */
    ...
    public static UserProfile getUserProfile(Context context) {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH){
            profile = getUserProfileOnIcsDevice(context);
            if(profile == null)
                profile = getUserProfileOnGingerbreadDevice(context);
        }else
            profile = getUserProfileOnGingerbreadDevice(context);
