    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        facebookLoginButton.registerCallback(mCallbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onError(FacebookException error) {
                LogManager.getLogger().e(DialADrink.TAG, "Facebook login error", error);
            }
        ...
        GraphRequest request = GraphRequest.newMeRequest(
                loginResult.getAccessToken(), new GraphRequest.GraphJSONObjectCallback() {
                    ...
                    public void onCompleted(JSONObject object, GraphResponse response) {
                        if (object == null) {
                            LogManager.getLogger().e(DialADrink.TAG, "Cannot get facebook user info after login");
                            return;
                        }
                        ...
                        try {
                            ...
                            LogManager.getLogger().e(DialADrink.TAG, "Cannot get facebook user info after login", e);
                            return;
                        }
                    }
                }
